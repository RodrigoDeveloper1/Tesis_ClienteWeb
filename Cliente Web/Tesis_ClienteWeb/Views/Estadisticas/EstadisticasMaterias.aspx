...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">    
    ...
    <div class="row">
            ...
            <div class="panel panel-yellow" id="panel-aprovvsrepro">
                <div class="panel-heading" id="panel-aprovvsrepro-heading">
                    ...
                    <div class="pull-right">
                        <a href="#" class="fa fa-file-pdf-o fa-2x" id="reporte-estadisticas-materias-aprobadosReprobados"></a>
                    </div>
                </div>
        ...
        <div class="col-xs-4">
            <div class="panel panel-yellow">
                ...
                <div class="panel-body descripcion-estadistica" id="3DescripciónMateria"></div>
            </div>
        </div>        
    ...
    <div class="row">
        ...
        <div class="col-xs-8">
            <div class="panel panel-green" id="panel-rankingalumnos">
                <div class="panel-heading">
                    ...
                    <div class="pull-right">
                        <a href="#" class="fa fa-file-pdf-o fa-2x" id="reporte-estadisticas-materias-top10Mejores"></a>
                    </div>
        ...
        <!-- Descripción -->
        <div class="col-xs-4">
            <div class="panel panel-green" id="1DescripciónMateria-div">
                <div class="panel-heading">
                    <i class="fa fa-list-alt fa-fw"></i>Descripción
                    <div class="separador-dialogos"></div>
                </div>
                <div class="panel-body descripcion-estadistica" id="1DescripciónMateria">
                </div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-xs-8">
            <div class="panel panel-primary" id="panel-ranking-peores">
                <div class="panel-heading">
                   ...
                   <div class="pull-right">
                       <a href="#" class="fa fa-file-pdf-o fa-2x" id="reporte-estadisticas-materias-top10Peores"></a>
                   </div>
                </div>
        ...
        <!-- Descripción -->
        <div class="col-xs-4">
            <div class="panel panel-primary" id="2DescripciónMateria-div">
                <div class="panel-heading">
                    <i class="fa fa-list-alt fa-fw"></i>Descripción
                    <div class="separador-dialogos"></div>
                </div>
                <div class="panel-body descripcion-estadistica" id="2DescripciónMateria">
                </div>
            </div>
        </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CSSContent" runat="server">
    <link href="../../Content/Css/Estadisticas/EstadisticasMaterias.css" rel="stylesheet" type="text/css" />
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="JSContent" runat="server">
    ...
    <script src="../../Scripts/Views/Estadisticas/EstadisticasMaterias.js" type="text/javascript"></script>
