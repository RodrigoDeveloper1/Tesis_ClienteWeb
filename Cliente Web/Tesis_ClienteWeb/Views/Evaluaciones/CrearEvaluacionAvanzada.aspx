...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% using (Html.BeginForm("CrearEvaluacionAvanzada", "Evaluaciones", FormMethod.Post, new
               {
                   @class = "form",
                   @role = "form"
               }))
    ...
    <div class="row">
        ...
        <div class="col-xs-6 text-left">
            <% using (Html.BeginForm("CrearEvaluacion", "Evaluaciones", FormMethod.Get, new
            {
                @class = "form",
                @role = "form"
            }))
...
<asp:Content ID="Content4" ContentPlaceHolderID="JSContent" runat="server">
     <script src="../../Scripts/Views/Evaluaciones/CrearEvaluacionAvanzada.js" type="text/javascript"></script>
...
<asp:Content ID="Content5" ContentPlaceHolderID="TituloPagina" runat="server">
    Maestras - Crear evaluación avanzada
</asp:Content>