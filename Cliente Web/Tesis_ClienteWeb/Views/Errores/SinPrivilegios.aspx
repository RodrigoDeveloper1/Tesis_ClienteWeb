        ...
        <div class="container">
            <div class="row">                
                <div class="col-lg-6">
                 ...
                 <div class="col-lg-6">
                    <div class="intro-text">
                        <h1 class="name">¡No tiene privilegios!</h1>   
                        <h3 class="">No tiene permisos para realizar esta acción en la página. Debe solicitar
                             permisos al administrador. Puede regresar a la página de inicio
                        </h3>
