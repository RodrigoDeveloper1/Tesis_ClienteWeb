...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        ...
        <div class="col-xs-5">
            <% using (Html.BeginForm("AgregarRol", "Administrador", FormMethod.Post, new
               {
                   @class = "form",
                   @role = "form"
               }))
            ...
            <div class="form-group col-xs-12">
                ...
                <%: Html.TextBoxFor(m => m.RolName, new { @PlaceHolder = "Nombre del rol",
                        @class = "form-control", @id = "text-box-rol"}) %>
            </div>
...
<asp:Content ID="Content4" ContentPlaceHolderID="JSContent" runat="server">
    ...
    <script src="../../Scripts/Views/Administrador/AgregarRol.js" type="text/javascript"></script>
</asp:Content>

<asp:Content ID="Content5" ContentPlaceHolderID="TituloPagina" runat="server">
    Maestras - Agregar rol
</asp:Content>