    ...
    $.post("/Bridge/ObtenerSelectListLapsos",
        ...
        function (data) {
            if (data != null && data.length > 0) {
                ...
                hideProgress();
                swal("¡Oops!", "El colegio no posee lapsos asociados", "warning");
    ...
    $.post("/Bridge/ObtenerSelectListCursos",
        ...
        function (data) {
            if (data != null && data.length > 0) {
                ...
                hideProgress();
                swal("¡Oops!", "El lapso no posee cursos asociados", "warning");
    ...
    $.post("/Bridge/ObtenerSelectListMateriasPorLapsoYCurso",
        ...
        function (data) {
            if (data != null && data.length > 0) {
                ...
                hideProgress();
                swal("¡Oops!", "El curso no posee materias asociadas", "warning");
    ...
    $.post("/Bridge/ObtenerSelectListProfesores",
        ...
        function (data) {
            if (data != null && data.length > 0) {
                ...
                hideProgress();
                swal("¡Oops!", "El curso no posee docentes asociados", "warning");
